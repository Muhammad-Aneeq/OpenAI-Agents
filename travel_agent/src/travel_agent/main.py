...
async def main(message):
    ...
    if question_index < len(QUESTIONS):
        ...
        if question_index < len(QUESTIONS):
            ...
            # summary = f"Thanks for providing your details. Here's what you shared:\n{travel_details}"
            ...
            # If create_travel_plan is asynchronous, use: result = await create_travel_plan(travel_details)
            ...
            final_output = (
                ...
                # f"**Local Insights:** {local_insights}\n"
